...
{
	public static Game gameInstanse;
	...
	[Space(10)]
	public int tankStartHealth = 10;						//The health the player tanks will get when the game starts.
	...
	void Start ()
	{
		...
		NetworkManager.instance.Join(PlayerPrefs.GetString("Name"));

//		GameObject tank = Instantiate(TANK, spawnPoints[Random.Range(0, spawnPoints.Count)].transform.position, Quaternion.identity) as GameObject;
//		tank.transform.parent = GameField;
//
//		GameObject tank2 = Instantiate(TANK, spawnPoints[Random.Range(0, spawnPoints.Count)].transform.position, Quaternion.identity) as GameObject;
//		var tanchik = tank2.transform.Find ("Player").gameObject.GetComponent<Tank>();
//		tanchik.id = 1;
//		var sprite = tank2.transform.Find ("Player").gameObject.GetComponent<SpriteRenderer>();
//		sprite.color = Color.red;
//		tank2.transform.parent = GameField;
